...
export class AudioManager {
    audio: { [key: string]: AudioEntity } = {
        button_interact: new AudioEntity( AudioNames.button_interact, { volume: 0.6, pitch: 1, loop: false, autoPlay: false }),
        ...
        island_ambiental: new AudioEntity( AudioNames.island_ambiental, { volume: 1, pitch: 1, loop: true, autoPlay: false }),
        ...
        portal_ambiental: new AudioEntity( AudioNames.portal_ambiental, { volume: 0.6, pitch: 1, loop: true, autoPlay: false }),
        puzzle_all_connect: new AudioEntity( AudioNames.puzzle_all_connect, { volume: 0.6, pitch: 1, loop: false, autoPlay: false }),
        puzzle_interact: new AudioEntity( AudioNames.puzzle_interact, { volume: 0.6, pitch: 1, loop: false, autoPlay: false }),
        tobor_talk: new AudioEntity( AudioNames.tobor_talk, { volume: 0.6, pitch: 1, loop: false, autoPlay: false }),
        tower_activated: new AudioEntity( AudioNames.tower_activated, { volume: 0.6, pitch: 1, loop: false, autoPlay: false }),
